        ...
        child: RefreshIndicator(
          ...
          child: Stack(
            children: [
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TitleRow(title: getTranslated('CATEGORY', context),
                                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => AllCategoryScreen(0)))),
                          ),
                          ...
                          Consumer<FlashDealProvider>(
                            builder: (context, megaDeal, child) {
                              return  (megaDeal.flashDeal != null && megaDeal.flashDealList != null && megaDeal.flashDealList.length > 0)
                                  ? Container(height: MediaQuery.of(context).size.width*1.09,
                                  child: Padding(
                                    padding: const EdgeInsets.only(bottom: Dimensions.HOME_PAGE_PADDING),
              ...
              Positioned(top: MediaQuery.of(context).size.height-70,
                left: 0,right: 0,
