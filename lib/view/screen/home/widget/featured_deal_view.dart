    ...
    return Consumer<FeaturedDealProvider>(
      builder: (context, featuredDealProvider, child) {
        ...
        ListView.builder(
          ...
          3 : featuredDealProvider.featuredDealList.length,
                ...
                child: Stack(children: [
                  Row(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                    ...
                    Expanded(
                      flex: 6,
                      child: Padding(
                        padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL-5),
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: robotoRegular.copyWith(height: 1.1,fontSize: Dimensions.FONT_SIZE_SMALL),
                              maxLines: 2,
