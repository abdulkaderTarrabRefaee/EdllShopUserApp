          ...
          children: [
            ...
            InkWell(
              ...
              child: Stack(
                children: [
                  Container(
                    width: MediaQuery.of(context).size.width/12,height: MediaQuery.of(context).size.width/5.5,
                  ...
                  Positioned(left: 5,right: 5,top: 18,bottom: 18,
                    child: Container(
                      width: 15,height: 15,
                      decoration: BoxDecoration(
...
class TimerBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: MediaQuery.of(context).size.width/7.5,height: MediaQuery.of(context).size.width/6.5,
      decoration: BoxDecoration(
        color: isBorder ? null : ColorResources.getPrimary(context),
        border: isBorder ? Border.all(width: 3, color: ColorResources.getPrimary(context)) : null,
